...
test('should return object', () => {
  expect(
    ...
    fontSize: '1.2500rem',
    lineHeight: 1.5,
    '@media (min-width: 56.2500rem)': { fontSize: '1.6406rem', lineHeight: 1.52 },
    '@media (min-width: 62.5000rem)': { fontSize: '2.0313rem', lineHeight: 1.55 },
    '@media (min-width: 68.7500rem)': { fontSize: '2.4219rem', lineHeight: 1.58 },
    '@media (min-width: 75.0000rem)': { fontSize: '2.8125rem', lineHeight: 1.6 },
    '@media (min-width: 78.1250rem)': { fontSize: '3.0469rem', lineHeight: 1.58 },
    '@media (min-width: 81.2500rem)': { fontSize: '3.2813rem', lineHeight: 1.55 },
    '@media (min-width: 84.3750rem)': { fontSize: '3.5156rem', lineHeight: 1.52 },
